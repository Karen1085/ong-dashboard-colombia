...
with t4: st.markdown("<div class='grafica-explicacion'>cruza la Exposición a Cultivos Ilícitos eje X con la brecha de productividad eje Y cada burbuja es un productor, los productores arriba y hacia la derecha representan son productores que logran buena productividad (muy por encima de la media) a pesar de operar en territorios con una presión histórica de economías ilegales.</div>", unsafe_allow_html=True)
